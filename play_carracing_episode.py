...
def play_episode(npy_path: str | Path, fps: int = 50, loop: bool = False) -> None:
    ...
    ----------
    npy_path : str | Path
        Path to the .npy file produced by collect_carracing_frames.py
...
if __name__ == "__main__":
    ...
    parser.add_argument("--npy", type=str, help="Path to episode_XXXXX.npy", default="data/carracing/episode_00000.npy")
